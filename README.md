...
This project is a NFT preview card.

## :confetti_ball: Preview:

![NFT card](.github/screenshot.png)

## :paperclip: Links:

- Solution URL: https://www.frontendmentor.io/solutions/nft-card-KhYyZ_PJn0
- Live Site URL: https://nft-card.ianramos.dev
...
- I learned to better use box-shadows to highlight certain components of the page for the user.
- I understand better how to use CSS pseudoselectors to create certain animations and transitions.
